...
if __name__ == '__main__':
    ...
    if len(argv) == 1:
        ...
        output = raw_input('Please enter the file path for output: ')
    ...
    qs = search_vizier_for_sources(ra, dec, radius, catalog, output)
