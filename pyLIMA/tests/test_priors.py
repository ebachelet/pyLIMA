...
def test_all_parameters_boundaries():
    ...
    expected = [(0.500001, 10), (0, 6.283185307179586), (-150, 150),
                (-1.0, 1.0), (-9, 9), (0.0, 9), (-1.0, 1000),
                (1e-06, 1.0), (-20, 20), (-20, 20), (-0.5,0.5),
                (-0.5,0.5), (0.01, 10), (-90, 90), (-4096, 4096),
                (0, 360), (0.001, 100.0), (0.1, 100.0), (-10, 10),
                (-5, 5), (-5, 5.0), (5e-05, 0.05), (0.1, 10.0),
                (2400000, 2500000), (0.1, 500), (2400000, 2500000),
                (0.0, 10.0), (-1.0, 1.0), (-1, 1), (-10.0, 10.0),
                (-10.0, 10.0), (-10.0, 10.0), (1e-05, 1000),
                (-1.5707963267948966, 1.5707963267948966), (0.1, 10),
                (-0.25, 0.25), (-0.25, 0.25), (0.0, 6.283185307179586)]
