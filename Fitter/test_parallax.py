...
def test_annual_parallax():
    ...
    data_valerio = np.genfromtxt('/home/ebachelet/Desktop/nethome/Desktop/Microlensing/OpenSourceProject/Developement/Parallaxes/Valerio_OB140099.txt',delimiter=',')
    Event=event.Event()
