...
def main(path):
    ...
    Events_names=[i for i in os.listdir(Events_path) if 'OGLE' in i]
    Events=[]
    start=time.time()
    Results=[]
    Errors=[]
    ...
    for i in Events_names[0:] :
        #i='OGLE-2015-BLG-0973.phot'
        #i='Lightcurve_1549.dat'
...
if __name__=='__main__':
    path=  '/home/ebachelet/Desktop/nethome/Desktop/Microlensing/OpenSourceProject/SimulationML/'+Location+'/Lightcurves/'
    main(path)