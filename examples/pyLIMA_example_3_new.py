...
### Say, we have multiple telescopes around the world imaging the event in different bands and 
### at different time intervals.
### In addition, we also want to simulate bad weather, avoid pointing too close to the moon,
### and also account for observing limitations due to the location of the target in the sky relative 
...
### These do not represent any physical system and are likely off for the telescope/filter 
### combination that you as a user have defined, but they can be used as placeholders for you
...
### Now we have defined the MODEL we want to simulate, we have defined the telescopes and 
### fluxes in each observing band, so we just inject these into our simulator to produce 
### a light curve:
...
### Here's how you can do that. Let's fix the DSPL parameters to some values where the binary source model
...
### ... and we will replace all source and blend flux elements with our own values. We can assume 
